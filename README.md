...
```javascript
import { hammingDistance, levenshteinDistance } from 'https://cdn.jsdelivr.net/gh/stdlib-js/string-base-distances@v0.2.1-deno/mod.js';
```
...
```javascript
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/string-base-distances@v0.2.1-deno/mod.js';
