...
```javascript
import distances from 'https://cdn.jsdelivr.net/gh/stdlib-js/string-base-distances@v0.1.0-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { levenshteinDistance } from 'https://cdn.jsdelivr.net/gh/stdlib-js/string-base-distances@v0.1.0-esm/index.mjs';
```
...
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/string-base-distances@v0.1.0-esm/index.mjs';
