...
```javascript
import { levenshteinDistance } from 'https://cdn.jsdelivr.net/gh/stdlib-js/string-base-distances@v0.1.1-deno/mod.js';
```
...
```javascript
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/string-base-distances@v0.1.1-deno/mod.js';
